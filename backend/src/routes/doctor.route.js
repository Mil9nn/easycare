...
import { deleteDoctor, getAllDoctors, getDoctorsById, registerDoctor, updateDoctor } from "../controllers/doctor.controller.js";
...
router.get("/:doctorId", protectRoute, getDoctorsById);
