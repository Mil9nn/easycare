...
import { deleteDoctor, getAllDoctors, getDoctorById, registerDoctor, toggleDoctorStatus, updateDoctor } from "../controllers/doctor.controller.js";
...
router.put("/status/:doctorId", protectAdmin, toggleDoctorStatus);
